...
public class StockItemPriceTableCellRenderer extends HTMLTableCellRenderer {
...
//		
		...
		if (value!=null)
		{
			...
			if (!stockItem.isNew())
			{
				...
				result = super.getTableCellRendererComponent(table,""+stockItem.getPrice(), isSelected,
							hasFocus, row, column);
